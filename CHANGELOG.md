...
- Crashes with 'ui is not defined' when displaying where a local copy was saved (again)

## [1.2.1] - 2021-06-03

### Fixed

- Crashes with 'ui is not defined' when displaying where a local copy was saved
...
[Unreleased]: https://github.com/ewen-lbh/ideaseed/compare/v1.2.2...HEAD
[1.2.2]: https://github.com/ewen-lbh/ideaseed/compare/v1.2.1...v1.2.2
[1.2.1]: https://github.com/ewen-lbh/ideaseed/compare/v1.2.0...v1.2.1
[1.2.0]: https://github.com/ewen-lbh/ideaseed/compare/v1.1.0...v1.2.0
